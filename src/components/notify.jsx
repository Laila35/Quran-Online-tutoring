...
const NotificationComponent = () => {
  ...
  "Stories of the Prophets",
    ...
    const interval = setInterval(showRandomNotification, 70000); // 70 seconds interval
  ...
  return (
    <div>
      {showNotification && (
        ...
        >
          <p className="text-md font-semibold">{currentNotification.name}</p>
          <p className="mt-1 text-xs">
            from {currentNotification.city} Subscribed to{' '}
            <span className="font-semibold text-blue-600">{currentNotification.course}</span> Course on{' '}
