...
export default function TutorCta({cta}) {
  return (
    <div className="bg-primary py-12 sm:py-16">
      <div className="  ">
        <div className="mx-auto max-w-2xl text-center">
          <h2 className="text-2xl font-semibold  text-white sm:text-3xl">
           {cta.heading || 'Learn Qur’an with Certified Male or Female Teachers'} 

          </h2>
          <p className="mx-auto mt-6 max-w-xl text-lg/8 text-pretty text-white">
            {cta.description || "Choose the teacher that suits your family’s needs. All teachers are certified, professional, and dedicated to spreading the knowledge of Qur’an and Sunnah."}  
          </p>
